    ...
    case 'EDIT_EXPENSE':
      return state.map((expense) => {
        if (expense.id === action.id) {
          return {
            ...expense,
            ...action.updates  // object spread operator.
          }
        } else {
          return expense;
        }
...
const expenseOne = store.dispatch(addExpense({ description: 'Renter', amount: 100, createdAt: -21000 }));
...
const demoState = {
  expenses: [{
    ...
    note: 'this was final pmt for that address',
